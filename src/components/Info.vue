                        ...
                        <template v-else>
                                ...
                                <v-row :gutter="200">
                                    <v-col span="8">
                                        <div class="item" :class="{active: info.code === 201 || info.code === 203 || info.code === 204}">
                                            ...
                                            <div class="margin-top-10 color-6"><span class="text">填写资料</span></div>
                                        </div>
                                    </v-col>
                                    <v-col span="8">
                                        <div class="item" :class="{active: info.code === 203 || info.code === 204}">
                                            <div><span class="num">2</span></div>
                                            <div class="margin-top-10 color-6"><span class="text">资料审核中</span></div>
                                        </div>
                                    </v-col>
                                    <v-col span="8">
                                        <div class="item" :class="{active: info.code === 204}">
                                            <div><span class="num">3</span></div>
                                            <div class="margin-top-10 color-6"><span class="text">报名成功</span></div>
                                        </div>
                                    </v-col>
                                </v-row>
                            </div>
                            ...
                            <template v-if="info.code === 201">
                                    ...
                                    <table class="ui-table">
                                        <tr>
                                            ...
                                            <td rowspan="4" style="width: 130px;">
                                                <div>
                                                    <img src="http://img.juimg.com/tuku/yulantu/121216/234733-12121621553935.jpg"
                                                         alt="" style="width: 130px;height: 160px;">
                                                </div>
                                                <div class="margin-top-10">
                                        ...
                                        <tr>
                                            <td>性别</td>
                                            <td>
                                                <v-select placeholder="请选择性别" style="width: 320px;" :data="sexType" @change="changeSex"></v-select>
                                            </td>
                                            <td>出生日期</td>
                                            <td>
                                                <v-date-picker
                                                    ...
                                                    style="width:320px;"></v-date-picker>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>毕业院校</td>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="4" class="color-6">
                                                <v-select placeholder="请课时选择" style="width: 320px;" :data="ksType" @change="changeKs"></v-select>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>身份证复印件上传</td>
                                ...
                                <div class="text-center margin-top-20">
                                    <v-button type="primary">保存报名表</v-button>
            ...
            reader.onload = function(theFile) {
                ...
                image.onload = function() {
                    ...
                    if(imgFile.size/1000 > 1000){
                        alert("上传的图片必须小于1M");
                        $("#wtFile").remove();
                        $("body").append('<input type="file" id="wtFile" name="file" onchange="ajaxFileUploadFn();" style="display: none;">');
                        return false;
                    }

                    $.ajaxFileUpload({
                        url: 'http://60.205.115.216/aci.api/public/api/file/upload',
                        secureuri: false,
                        fileElementId: 'file',
                        type: 'post',
                        dataType: 'json',
