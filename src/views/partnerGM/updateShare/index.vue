    ...
    <div class="panel-container">
      ...
      >
          ...
          <el-row>
            ...
            <el-col :span="13">
              <el-form-item prop="shareBonusAmout">
                <el-input
                  v-model="formTest2.shareBonusAmout"
        ...
        <el-form-item label="分享描述：" prop="sharePreRemarks">
          <el-input
            type="textarea"
            v-model="formTest2.sharePreRemarks"
            :rows="5"
            clearable
            placeholder="分享描述"
          ></el-input>
        ...
        <el-form-item label="分享图片：" prop="sharePreImgPath">
          ...
          >
            ...
            <div
              ...
              slot="tip"
              v-show="formTest2.sharePreImgPath ? true : false"
            >
              <img :src="formTest2.sharePreImgPath" width="300" height="300">
            </div>
          </el-upload>
        </el-form-item>
...
export default {
  data() {
    return {
      actionUrl:
        process.env.BASE_API + "/partner/upload/uploadFile?token=" + getToken(),
      formTest2: {
        links: "",
        shareName: "",
        bonusCount: 1,
      ...
      rulesTest2: {
        ...
        bonusCountType: [
          { required: true, message: "请选择奖励次数", trigger: "blur" }
        ],
        bonusCount: [
        ...
        sharePreTitle: [
          { required: true, message: "请输入任务预览标题", trigger: "blur" },
          { max: 15, message: "长度在15个字符以内", trigger: "blur" }
        ],
        sharePreRemarks: [
