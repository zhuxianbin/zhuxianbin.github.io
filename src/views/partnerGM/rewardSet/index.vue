<template>
  <div class="app-container">
    <div class="panel-container">
      ...
      <!--整租表格列表-->
      <el-table v-show="region == '1'" :data="list">
        ...
        <el-table-column label="策略名称" prop="strName"></el-table-column>
      ...
      <!--长短租表格列表-->
      <el-table v-show="region == '2'" :data="list">
        ...
        <el-table-column label="策略名称" prop="showName"></el-table-column>
