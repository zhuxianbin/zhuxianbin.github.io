    ...
    <div class="panel-container">
      ...
      <div class="xlsx-box">
        <el-button
          ...
          plain
          @click="clcikAdd"
          v-if="partner.permission.authority['HHR_SETTLEMENT_OBJECT'].includes('HHR_ADD_SETTLEMENT_OBJECT')"
        >添加</el-button>
      </div>
        ...
        <el-table-column label="操作" width="120">
          <template slot-scope="scope">
            <el-button
              ...
              v-if="partner.permission.authority['HHR_SETTLEMENT_OBJECT'].includes('HHR_UPDATE_SETTLEMENT_OBJECT')"
            >编辑</el-button>
